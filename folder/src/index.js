...
import reset_img from './images/reset.png';
...
class GameManager extends React.Component{
  ...
  Update(i) {
    ...
    i++;
    timeout = setTimeout(this.Update, timer_scale, i);
  }

  componentDidMount() {
    timeout = setTimeout(this.Update, timer_scale, 1);
  }
  ...
  render() {
    ...
    return (
      <div>
        ...
        <footer>Ikony stworzone przez Chanut ze strony flaticon</footer>
      </div>
    );
  }
}
